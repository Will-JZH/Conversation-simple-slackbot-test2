<Project DefaultTargets="Build" ToolsVersion="2.0" InitialTargets="ValidateSolutionConfiguration;ValidateToolsVersions" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup>
    <SolutionDir>C:\Users\IBM_ADMIN\Downloads\botkit-middleware-master\botkit-middleware-master\examples\simple-bot\node_modules\websocket\build\</SolutionDir>
    <SolutionExt>.sln</SolutionExt>
    <SolutionFileName>binding.sln</SolutionFileName>
    <SolutionName>binding</SolutionName>
    <SolutionPath>C:\Users\IBM_ADMIN\Downloads\botkit-middleware-master\botkit-middleware-master\examples\simple-bot\node_modules\websocket\build\binding.sln</SolutionPath>
  </PropertyGroup>
  <PropertyGroup>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{63EBC2F0-3DA0-23D9-D8CA-59F84D285755}">Debug|x64</ProjectConfiguration>
        <ProjectConfiguration Project="{44617D62-1F94-9B6C-C9D7-AECC7A7C12F9}">Debug|x64</ProjectConfiguration>
  ...
  <PropertyGroup Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') ">
    <CurrentSolutionConfigurationContents>
      <SolutionConfiguration xmlns="">
        <ProjectConfiguration Project="{63EBC2F0-3DA0-23D9-D8CA-59F84D285755}">Release|x64</ProjectConfiguration>
        <ProjectConfiguration Project="{44617D62-1F94-9B6C-C9D7-AECC7A7C12F9}">Release|x64</ProjectConfiguration>
      </SolutionConfiguration>
    </CurrentSolutionConfigurationContents>
  </PropertyGroup>
  ...
  <Target Name="bufferutil" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    <VCBuild Projects="C:\Users\IBM_ADMIN\Downloads\botkit-middleware-master\botkit-middleware-master\examples\simple-bot\node_modules\websocket\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="C:\Users\IBM_ADMIN\Downloads\botkit-middleware-master\botkit-middleware-master\examples\simple-bot\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <VCBuild Projects="C:\Users\IBM_ADMIN\Downloads\botkit-middleware-master\botkit-middleware-master\examples\simple-bot\node_modules\websocket\build\bufferutil.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="C:\Users\IBM_ADMIN\Downloads\botkit-middleware-master\botkit-middleware-master\examples\simple-bot\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
  ...
  <Target Name="validation" Condition="'$(CurrentSolutionConfigurationContents)' != ''">
    <VCBuild Projects="C:\Users\IBM_ADMIN\Downloads\botkit-middleware-master\botkit-middleware-master\examples\simple-bot\node_modules\websocket\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Debug|x64" SolutionFile="C:\Users\IBM_ADMIN\Downloads\botkit-middleware-master\botkit-middleware-master\examples\simple-bot\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Debug') and ('$(Platform)' == 'x64') " />
    <VCBuild Projects="C:\Users\IBM_ADMIN\Downloads\botkit-middleware-master\botkit-middleware-master\examples\simple-bot\node_modules\websocket\build\validation.vcproj" ToolPath="$(VCBuildToolPath)" Configuration="Release|x64" SolutionFile="C:\Users\IBM_ADMIN\Downloads\botkit-middleware-master\botkit-middleware-master\examples\simple-bot\node_modules\websocket\build\binding.sln" Override="$(VCBuildOverride)" AdditionalLibPaths="$(VCBuildAdditionalLibPaths)" UserEnvironment="$(VCBuildUserEnvironment)" AdditionalOptions="$(VCBuildAdditionalOptions)" Condition=" ('$(Configuration)' == 'Release') and ('$(Platform)' == 'x64') " />
  </Target>
